  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        >
          1. Click the button below to register on Telegram
        </Text>
        <Text
          style={{
            color: "white",
        ...
        >
          2. Enter /start to view the instructions
        </Text>
        <Text
          style={{
            color: "white",
        ...
        >
          3. Enter /register *password* to register yourself
        </Text>
        <Text
          style={{
            color: "white",
        ...
        >
          4. Alternatively, enter /changepassword *newpassword* if you wish to
      ...
      <TouchableOpacity
        style={styles.button}
        onPress={() => Linking.openURL("https://t.me/quickloadreminder_bot")}
      >
