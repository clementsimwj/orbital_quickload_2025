  ...
  const handlePress = async (
    ...
    if (status === "available") {
      ...
      try {
        ...
        Alert.alert(
          "Success",
          "Thank you for collecting your laundry and using QuickLoad! We wish you a good day ahead!"
        );
        fetchMachines();
      } catch (error: any) {
        console.log(error);
        Alert.alert(
          "Error",
          error.response?.data?.detail || "Failed to collect machine"
        );
      }
    }
  };
